...
function GuidedBreathing({ onComplete }: { onComplete: () => void }) {
  ...
  if (phase === "ready") {
    return (
      <motion.button
        ...
        className="w-full py-4 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-xl font-medium"
      >
  ...
  const phaseColors = {
    ...
    done: "from-yellow-400 to-orange-400",
  };
      ...
      <div className="flex items-center justify-center gap-4 mb-4">
        {days > 0 && (
          <div className="text-center">
            <span className="text-4xl font-bold text-slate-800">{days}</span>
    ...
    <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div className="bg-white/70 rounded-lg p-4 text-center">
          <p className="text-3xl font-bold text-green-700">{totalSolved}</p>
          <p className="text-xs text-green-600">Questions mastered</p>
        </div>
        <div className="bg-white/70 rounded-lg p-4 text-center">
    ...
    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
      ...
      <div className="space-y-3">
        {plan.map((step, i) => (
          <div
            key={i}
            className="flex items-start gap-3 bg-white/70 rounded-lg p-3"
          >
  ...
  (
    ...
    return (
      <motion.div
        ...
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 rounded-2xl border-2 border-indigo-200 overflow-hidden"
      >
        {/* Header */}
        ...
        <div className="flex border-b border-indigo-100 bg-white/50">
          {tabs.map((tab) => (
            <button
              ...
              className={cn(
                "flex-1 py-3 px-4 text-sm font-medium transition-colors flex items-center justify-center gap-1",
                activeTab === tab.id
                ...
                {showBreathing ? (
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="w-full py-4 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-xl font-medium hover:from-indigo-600 hover:to-purple-600 transition-all"
                    >
